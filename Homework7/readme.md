...
![Topology_act](https://github.com/EfremovaOD/Otus_Homeworks/blob/b241741500b8051f6f91bc5755ca78593359155d/photo/Homework7/Topology_Akt.PNG)
 ...
 ##### С учетом выходных данных, поступающих с коммутаторов, ответьте на следующие вопросы:
  ...
  b. Почему этот коммутатор был выбран протоколом spanning-tree в качестве корневого моста?
      ...
      S1 имеет наименьший MAC

  c. Какие порты на коммутаторе являются корневыми портами? 
  
      на  S2: f0/2 и S3:  f0/4, S1 - корневой и не  имеет корневых портов.

  d. Какие порты на коммутаторе являются назначенными портами? 
  
      S1 - корневой  и все его порты являются  назначенными, S2 имет назначенный  порт: f0/4.
  ...
  f. Почему протокол spanning-tree выбрал этот порт в качестве невыделенного (заблокированного) порта? 
      ...
      Маршрут считается неэффективным из-за его длинны. Будет использоваться как резервный в случае отказа корневого порта.
